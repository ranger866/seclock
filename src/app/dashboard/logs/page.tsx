...
export default function LogsPage() {
  ...
  useEffect(() => {
    const fetchLogs = async () => {
      try {
        ...
        console.error("Gagal menarik log data", error);
      } finally {
        setIsLoading(false);
      }
    };
  ...
  // Format tanggal agar lebih rapi dibaca (contoh: 3 Juni 2026, 08:00:00)
  ...
  return (
    ...
    >
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900">Log Akses Pintu</h2>
